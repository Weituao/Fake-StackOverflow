...
export default function SignUpContainer({ updatePage: changep }) {
  ...
  function isthesingup() {
    const itiswrong = {
      ...
      password: userp.password.length === 0 ? 'Cannot have empty password' : userp.emailAddress.includes(userp.password) || userp.userName.includes(userp.password) ? 'Password cannot contain email or username' : null,
  ...
  return React.createElement(React.Fragment, null,
    React.createElement("div", { className: "sulg-container" },
      ...
      React.createElement("div", { className: "sulg-form" },
        ...
        React.createElement("label", { htmlFor: "username", className: "test-error", id: "f-error", style: { fontStyle: 'italic' } },
        ...
        React.createElement("br", null),
        React.createElement("label", { htmlFor: "email", className: "test-error", id: "f-error", style: { fontStyle: 'italic' } },
        ...
        React.createElement("br", null),
        React.createElement("label", { htmlFor: "password", className: "test-error", id: "f-error", style: { fontStyle: 'italic' } },
        ...
        React.createElement("br", null),
        React.createElement("label", { htmlFor: "confirmPassword", className: "test-error", id: "f-error", style: { fontStyle: 'italic' } },
