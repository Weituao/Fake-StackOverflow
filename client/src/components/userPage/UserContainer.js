...
function UserContainer({ userid, updatePage }) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "div",
        { className: "user-all-questions-container" },
        React.createElement(
          "h2",
          { className: "user-page-heading-title" },
          questions.length === 0
        ...
        questions.length === 0
          ...
          : questions.map(function (question) {
            function handleDeleteClick() {
              showWarningQuestion.warning ? deleteQuestion() : setShowWarningQuestion({ warning: true, questionId: question._id });
            }            
              ...
              function deleteQuestion() {
                ...
                axios
                  ...
                  .then(function (res) {
                    switch(res.data) {
                      case 'success':
                        const newQuestions = questions.filter(function (question) {
                          return question._id !== questionIdToDel;
                        });
              ...
              return React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      "h2",
                      {
                        id: question._id,
                        onClick: function () {
                          getTagById(question.tagId).then(function (tags) {
                ...
                React.createElement(
                  "button",
                  { id: "user-self-delete-button", onClick: handleDeleteClick },
                  "Delete"
                ),
        ...
        React.createElement(
          "button",
          {
            ...
            onClick: function () {
              axios
                .get(`http://localhost:8000/posts/answers/getQuestionsAnswered/${userid}`)
                .then(function (res) {
                  updatePage({
          ...
          "All Questions that Contain Answers By ",
          user.username,
          " "
        )
      )
